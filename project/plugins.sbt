...
libraryDependencies += "org.eclipse.jetty"  % "jetty-server" % "8.1.19.v20160209"

libraryDependencies += "org.eclipse.jetty"  % "jetty-servlet" % "8.1.19.v20160209"

libraryDependencies += "org.eclipse.jetty"  % "jetty-webapp" % "8.1.19.v20160209"

libraryDependencies += "org.eclipse.jetty"  % "jetty-util" % "8.1.19.v20160209"
